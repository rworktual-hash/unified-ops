...
class Settings(BaseSettings):
    ...
    # Comma-separated IPs for GPU product SSH collect, or * for all gpu servers.
    # Inactive hosts (165/166) are still skipped by collect_all_active_servers.
    gpu_product_collect_ips: str = "*"
