...
def collect_and_store_email_ssh(db: Session, server: Server) -> EmailSshSnapshot | None:
    ...
    row = EmailSshSnapshot(
        ...
        queue_messages=snap.queue_messages,
        queue_size_kb=snap.queue_size_kb,
        queue_active=snap.queue_active,
        queue_deferred=snap.queue_deferred,
        queue_hold=snap.queue_hold,
        postfix_active=snap.postfix_active,
        dovecot_active=snap.dovecot_active,
        opendkim_active=snap.opendkim_active,
        amavis_active=snap.amavis_active,
        clamav_active=snap.clamav_active,
        ...
        log_reject_lines=snap.log_reject_lines,
        log_bounce_lines=snap.log_bounce_lines,
        log_amavis_lines=snap.log_amavis_lines,
        log_spam_lines=snap.log_spam_lines,
        fail2ban_banned=snap.fail2ban_banned,
